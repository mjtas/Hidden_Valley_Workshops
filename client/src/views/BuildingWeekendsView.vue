    ...
    <div class="main">
      <div class="main-container">
        <div class="other-heading">
          <h1>Hidden Valley</h1>
          <h2>Garden Design and Practical Skills Consulting</h2>
          </div>
