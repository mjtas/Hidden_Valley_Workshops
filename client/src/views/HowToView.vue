        ...
        <div class="main-heading">
          ...
          <div class="guide-right">
            <ul class="main-text">
              ...
              <li class="main-li" v-if="selectedGuideTitle==''">{{ howToIntro3 }}</li>
